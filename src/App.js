    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button onClick={() => setHomeScore(homeScore + 2)} className="homeButtons__fieldGoal">Home Safety</button>
          <button onClick={() => setHomeScore(0)} className="homeButtons__fieldGoal">Home Reset Score</button>
        </div>
        <div className="awayButtons">
          ...
          <button onClick={() => setAwayScore(awayScore + 2)} className="homeButtons__fieldGoal">Away Safety</button>
          <button onClick={() => setAwayScore(0)} className="homeButtons__fieldGoal">Away Reset Score</button>
        </div>
      </section>
    </div>
  );
